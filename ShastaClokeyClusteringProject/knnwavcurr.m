...
%%%%%%%%%%%%%doing knn for all of the data%%%%%%%%%%%%%%%%%%%%
classifications = trainingdata(:,5);
mdl = fitcknn(trainingdata(:,1:4), classifications,'NumNeighbors',18);
...
%%%%%%%%%%%%%%%%%doing knn again but with only cols 1 and 2%%%%%%%%%%%
mdl = fitcknn(trainingdata(:,[1 2]), classifications,'NumNeighbors',18);
...
legend('Train Real Assign','Train Fake Assign','Train Real','Train Fake',...
        ...
        'Location','SW')
title 'K NN Cluster Assignments(wavCurr)'
