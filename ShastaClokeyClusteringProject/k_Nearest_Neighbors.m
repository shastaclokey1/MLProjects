...
mdl = fitcknn(trainingdata, classifications,'NumNeighbors',4);
...
%%%%%%%%%%%%%%%%doing knn with only cols 4 and 6%%%%%%%%%%%%%%%%
mdl = fitcknn(trainingdata(:,[4 6]), classifications,'NumNeighbors',4);
...
legend('Train Real Assign','Train Fake Assign','Train Real','Train Fake',...
        ...
        'Location','SW')
title 'K NN Cluster Assignments(measFeats)'
